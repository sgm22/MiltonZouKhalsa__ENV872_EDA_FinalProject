...
kable(meta_data_tab, col.names = c("Variable", "Description", "Coding", "Units", "Minimum.Value", "Maximum.Value", "Missing"),
                      caption="COVID-19 Metadata", row.names=FALSE, align=c("l",rep("r",3)),
...
kable(collapsed_dat_settlement_types, caption = "Summary of COVID and Population Data by Settlement Types") %>%
  kable_styling(latex_options="full_width = TRUE") #Generate Table
...
```{r, message=FALSE, warning=FALSE, fig.cap= "Population of New York Counties", fig.align='left', fig.height= 2.5 }
...
```{r, message=FALSE, warning=FALSE, fig.cap= "Settlement Types of New York Counties", fig.align='left', fig.height= 2.5 }
...
```{r, message=FALSE, warning=FALSE, fig.cap= "Cumulative Number of Tests Administered in Each New York County", fig.align='left', fig.height= 2.5 }
 
# Map the sum of the cumulative number of tests administered in each New York county in 2022.
ggplot() +
  geom_sf(data = combined_dat_join, aes(fill = log(sum_cumulative_no_of_tests))) +
  scale_fill_gradientn(colours = terrain.colors(10)) +
  ggtitle("COVID-19 in New York",
...
```{r, message=FALSE, warning=FALSE, fig.cap= "Cumulative Number of Positive Test Results in Each New York County", fig.align='left', fig.height= 2.5 }
 
# Map the sum of the cumulative number of positive test results in each New York county in 2022.
ggplot() +
  geom_sf(data = combined_dat_join, aes(fill = log(sum_cumulative_no_of_positive))) +
  scale_fill_gradientn(colours = terrain.colors(10)) +
  ggtitle("COVID-19 in New York",
