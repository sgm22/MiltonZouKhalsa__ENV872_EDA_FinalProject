...
```{r, message=FALSE, warning=FALSE, fig.cap= "Population of New York Counties", fig.align='left', fig.height= 4, fig.width= 5}
...
```{r, message=FALSE, warning=FALSE, fig.cap= "Settlement Types of New York Counties", fig.align='left', fig.height= 4, fig.width= 5}
...
```{r, message=FALSE, warning=FALSE, fig.cap= "Cumulative Number of Tests Administered in Each New York County", fig.align='left', fig.height= 4, fig.width= 5}
...
```{r, message=FALSE, warning=FALSE, fig.cap= "Cumulative Number of Positive Test Results in Each New York County", fig.align='left', fig.height= 4, fig.width= 5}
